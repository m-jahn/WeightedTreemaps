...
```{r, fig.width = 10, fig.height = 5, out.width = "100%", fig.align = 'center', warning = FALSE, eval = FALSE}
drawTreemap(
  tm, 
...
```{r, fig.width = 20, fig.height = 8, out.width = "100%", fig.align = 'center', eval = FALSE}
